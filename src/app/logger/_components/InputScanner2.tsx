...
const InputScanner2 = () => {
    ...
    const handleScan = async (purpose: string) => {
        ...
        try {
            ...
            const response = await axios.post<Attendance>(`${env.NEXT_PUBLIC_API_URL!}/attendanceV2/`, dataToSend);
                    ...
                    <div className="relative size-[316px]">
                        ...
                        <p className="size-[316px] absolute left-1/2 top-0 z-10 -translate-x-1/2 transform font-oswald text-2xl font-bold">
                            ...
                            {studentDetails?.course === Course.BSIT ? (
                                <Image src={"/images/info_tech.png"} fill sizes="30vw" alt="Info Tech" />
                            ) : studentDetails?.course === Course.BSA ? (
                                <Image src={"/images/accountancy.png"} fill sizes="30vw" alt="Accountancy" />
                            ) : studentDetails?.role === Role.Teacher ? (
                                <Image src={"/images/faculty.png"} fill sizes="30vw" alt="Qr green" />
                            ) : (
                                <Image src={"/images/gjchomepagelink.png"} fill sizes="30vw" alt="Qr green" />
                            )}
                        </p>
